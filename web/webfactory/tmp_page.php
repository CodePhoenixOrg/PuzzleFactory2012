		...
		<tr>
			<td align='center' valign='top' bgcolor='<?php   echo $panel_colors["back_color"]?>'>
				...
				<tr>
					<td>cl_title</td>
					<td>
						<input type='text' name='cl_title' value='<?php   echo $cl_title?>'>
					</td>
				</tr>
				<tr>
					<td>cl_text</td>
					<td>
						<textarea name='cl_text' cols='80' rows='5'><?php   echo $cl_text?></textarea>
					</td>
				</tr>
				<tr>
					<td>cl_date</td>
				...
				<tr>
					<td>cl_time</td>
					<td>
						<input type='text' name='cl_time' value='<?php   echo $cl_time?>'>
					</td>
				</tr>
				<tr>
					<td>fr_id</td>
