		...
		<tr>
			<td align='center' valign='top' bgcolor='<?php   echo $panel_colors["back_color"]?>'>
				...
				<tr>
					<td>fr_title</td>
					<td>
						<input type='text' name='fr_title' value='<?php   echo $fr_title?>'>
					</td>
				</tr>
				<tr>
					<td>fr_description</td>
					<td>
						<textarea name='fr_description' cols='80' rows='5'><?php   echo $fr_description?></textarea>
					</td>
				</tr>
				<tr>
					<td>fr_date</td>
					<td>
						<input type='text' name='fr_date' value='<?php   echo $fr_date?>'>
					</td>
				</tr>
				<tr>
					<td>fr_table_name</td>
					<td>
						<input type='text' name='fr_table_name' value='<?php   echo $fr_table_name?>'>
					</td>
				</tr>
				<tr>
					<td>me_id</td>
					<td>
						...
						$options=create_options_from_query($sql, 0, 1, array(), $me_id, false, $cs);
						echo $options["list"];?>
						</select>
					</td>
				</tr>
