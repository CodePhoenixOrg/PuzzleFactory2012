...
CREATE TABLE agence_client (
  ...
  ag_path varchar(50) NOT NULL default '',
  ag_type char(3) NOT NULL default '',
...
CREATE TABLE taches (
  ...
  realise int(1) NOT NULL default '0',
  att_index int(11) NOT NULL default '0',
